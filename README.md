...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/little-bar-a5bf)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/little-bar-a5bf
```

A live public deployment of this template is available at [https://little-bar-a5bf.templates.workers.dev](https://little-bar-a5bf.templates.workers.dev)
